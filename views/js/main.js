...
for (var i = 0, len = document.getElementsByClassName(".randomPizzaContainer"); i < len.length; i++) {
      var newwidth = (len[i].offsetWidth + dx) + 'px';
      var dx = determineDx(len[i], size);
      len[i].style.width = newwidth;
    }
  }
